  ...
  useEffect(() => {
    if (chatClient) {
      ...
      if (channelId) {
        ...
        const timeoutId = setTimeout(() => setActiveChannel(channel), 0);
        return () => clearTimeout(timeoutId);
      } else {
        // Clear active channel when no channel id is present, also deferred
        const timeoutId = setTimeout(() => setActiveChannel(null), 0);
        return () => clearTimeout(timeoutId);
      }
    }
